...
import {View, Text, Image, TouchableOpacity, StyleSheet, async} from 'react-native';
...
GoogleSignin.configure({
  webClientId: '318990413225-ofpmvg1s4nm1q6ocnb6lv618cnotqane.apps.googleusercontent.com',
});
...
export default class Login extends Component {
  ...
  // want to save asynchonyse storage-------------
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TextInput style={styles.txtinput1} label="Email"
